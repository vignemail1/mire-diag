 ...
 * mtr est prefere sur macOS/Linux car il combine ping et traceroute.
 * Options mtr : -z (affiche les numeros AS), -b (affiche hostname ET IP),
 *               -r (mode rapport), -w (noms complets), --report-cycles 5.
 * @param {string} os
 * @param {string} fqdn
 * @returns {{ cmd: string, cmd6: string, hint: string }}
 */
  ...
  switch (os) {
    ...
    case 'macos':
      return {
        ...
        hint: 'Si mtr est installe, preferez : mtr -z -b -rw --report-cycles 5 ' + target
      };
    case 'linux':
    default:
      return {
        ...
        hint: 'mtr est preferable car il combine ping et traceroute : mtr -z -b -rw --report-cycles 5 ' + target
      };
  }
}
